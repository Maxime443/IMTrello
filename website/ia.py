...
def time_estim(experiences,desc_tache):
...
print(time_estim(['confirmé'],'Réalisation d un algorithme Dijstra simple en Python qui doit permettre de trouver le plus court chemin dans un graphe à 20 noeuds'))
